...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Rahmat Berlianda</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">Admin Template Rahmat</a>.</strong>
    All rights reserved.
...
<!-- jQuery -->
<script src="{{asset('assets/plugins/jquery/jquery.min.j')}}s"></script>
<!-- jQuery UI 1.11.4 -->
